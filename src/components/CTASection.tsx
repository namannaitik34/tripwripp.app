...
const CTASection: React.FC = () => {
  return (
    <section className="py-12 sm:py-16 relative overflow-hidden" style={{ backgroundColor: '#F5F5DC' }}>
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        {/* Camera */}
        <motion.div
          className="absolute text-2xl sm:text-3xl opacity-50"
          animate={{
            scale: [1, 1.2, 1],
            rotate: [-5, 5, -5],
          }}
      ...
      <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-3 sm:mb-4" style={{ color: '#0d1d30' }}>Ready for Your Next Adventure?</h2>
          <p className="text-base sm:text-lg lg:text-xl mb-6 sm:mb-8 text-gray-700 leading-relaxed px-2">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center">
            <Link 
              href="/packages#customize-trip"
              className="text-white px-6 sm:px-8 py-3 sm:py-4 rounded-xl transition-all duration-200 ease-out hover:opacity-90 hover:shadow-xl hover:-translate-y-2 hover:scale-105 active:scale-95 font-semibold inline-flex items-center group relative overflow-hidden min-h-[44px] w-full sm:w-auto"
            ...
            <Link 
              href="/packages"
              className="border-2 px-6 sm:px-8 py-3 sm:py-4 rounded-xl transition-all duration-200 ease-out hover:shadow-lg hover:-translate-y-1 hover:scale-105 active:scale-95 font-semibold inline-flex items-center group relative overflow-hidden min-h-[44px] w-full sm:w-auto"

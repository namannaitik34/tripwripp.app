        ...
        >
          <div className="sticky top-24 bg-white rounded-xl shadow-lg p-6 flex flex-col gap-4 overflow-hidden">
            <div className="w-full flex flex-col items-stretch">
              ...
              {/* Requirements Tab - now fully inside card */}
              <div className="mt-4 w-full px-2 pb-2">
                {/* Tab Bar: 2x2 grid on mobile, 1 row on md+ */}
                <div className="grid grid-cols-2 gap-2 border-b mb-2 md:flex md:gap-2 md:border-b md:mb-2">
                  <button className="py-2 px-4 font-semibold text-blue-600 border-b-2 border-transparent hover:border-blue-600 focus:border-blue-600 focus:outline-none w-full text-left">Overview</button>
                  <button className="py-2 px-4 font-semibold text-blue-600 border-b-2 border-transparent hover:border-blue-600 focus:border-blue-600 focus:outline-none w-full text-left">Itinerary</button>
                  <button className="py-2 px-4 font-semibold text-blue-600 border-b-2 border-transparent hover:border-blue-600 focus:border-blue-600 focus:outline-none w-full text-left">What's Included</button>
                  <button className="py-2 px-4 font-semibold text-blue-600 border-b-2 border-transparent hover:border-blue-600 focus:border-blue-600 focus:outline-none w-full text-left">Requirements</button>
                </div>
                <div className="bg-blue-50 rounded-md p-3 text-sm text-blue-900 w-full">
                  {pkg.requirements && pkg.requirements.length > 0 ? (
                    ...
                    <span>No specific requirements for this package.</span>
                  )}
                </div>
              </div>

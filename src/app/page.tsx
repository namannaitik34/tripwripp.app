                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 w-full">
                      ...
                      <div className="flex flex-col gap-2 sm:flex-row sm:gap-2 sm:items-center">
                        ...
                        <button
                          type="button"
                          className="bg-orange-500 text-white px-3 sm:px-4 py-2 rounded-lg transition-all duration-200 ease-out hover:bg-orange-600 hover:shadow-lg hover:-translate-y-1 hover:scale-105 active:scale-95 text-sm sm:text-base min-h-[44px] flex items-center"
                          style={{ backgroundColor: '#FF8F00' }}
                        >
                          Book Now
                        </button>
